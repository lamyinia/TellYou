...
public enum MessageTypeEnum {
    ...
    PRIVATE_VOICE(4, MQConstant.SESSION_TOPIC, "语音"),
    PRIVATE_FILE(5, MQConstant.SESSION_TOPIC, "文件"),
    ...
    GROUP_VOICE(9, MQConstant.SESSION_TOPIC, "语音"),
    GROUP_FILE(10, MQConstant.SESSION_TOPIC, "文件"),
    SYSTEM_ENTER_NOTIFY(51, MQConstant.SESSION_TOPIC, "系统通知入群"),
    SYSTEM_EXIT_NOTIFY(52, MQConstant.SESSION_TOPIC, "系统通知退群"),
