...
public class MediaController {
    ...
    public ApiResult<PictureUploadResp> getPictureUploadUrl(@Valid @RequestBody PictureUploadReq req){
        return ApiResult.success(mediaService.getPictureUploadResp(req));
    }
    ...
    public ApiResult<VoiceUploadResp> getVoiceUploadUrl(@Valid @RequestBody VoiceUploadReq req){
        return ApiResult.success(mediaService.getVoiceUploadResp(req));
    }
    ...
    public ApiResult<VideoUploadResp> getVideoUploadUrl(@Valid @RequestBody VideoUploadReq req){
        return ApiResult.success(mediaService.getVideoUploadResp(req));
    }
    ...
    public ApiResult<FileUploadResp> getFileUploadUrl(@Valid @RequestBody FileUploadReq req){
        return ApiResult.success(mediaService.getFileUploadResp(req));
    }
    ...
    */
    ...
    public ApiResult<Void> confirmPictureUpload(@Check @Valid @RequestBody PictureUploadConfirmReq req){
        mediaService.confirmPictureUpload(req);
        return ApiResult.success();
    }
    ...
    public ApiResult<Void> confirmVoiceUpload(@Check @Valid @RequestBody VoiceUploadConfirmReq req){
        mediaService.confirmVoiceUpload(req);
        return ApiResult.success();
    }
    ...
    public ApiResult<Void> confirmVideoUpload(@Check @Valid @RequestBody VideoUploadConfirmReq req){
        mediaService.confirmVideoUpload(req);
        return ApiResult.success();
    }
    ...
    public ApiResult<Void> confirmFileUpload(@Check @Valid @RequestBody FileUploadConfirmReq req){
        mediaService.confirmFileUpload(req);
        return ApiResult.success();
    }
}
