package org.com.modules.session.service.retry;
...
public class MessageDelayQueue {
     ...
     */
    ConcurrentHashMap<String, MessageResp> messageCache = new ConcurrentHashMap<>();
    ...
    public void initCache4Deliver(Long uid, MessageResp vo){
    ...
    public void initCache4Group(List<Long> uidList, MessageResp vo){
        String messageId = vo.getMessageId();
        messageCache.put(messageId, vo);
        scheduleCleanup(messageId);
     ...
     * @param timeUnit 时间单位
     */
    public void submitWithDelay(Long uid, MessageResp vo, long delay, TimeUnit timeUnit){
        try {
    ...
    public void processDelayedMessage(){
        ...
        for (int i = 0; i < 300; ++ i){
            ...
            MessageResp vo = messageCache.get(messageId);
    ...
    private String locating(Long uid, MessageResp vo){
