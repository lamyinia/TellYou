...
import org.com.server.netty.protocal.HeartBeatRule;
import org.com.server.netty.protocal.WebSocketRule;
        ...
        serverBootstrap.channel(NioServerSocketChannel.class)
                ...
                .childHandler(new ChannelInitializer<Channel>(){
                    ...
                    protected void initChannel(Channel channel) throws Exception {
                        ...
                        pipeline.addLast(new WebSocketRule());
                    }
                });

        try {
            ChannelFuture sync = serverBootstrap.bind(nettyProperties.getPort()).sync();
            log.info("Netty 服务端启动成功, 端口:{}", nettyProperties.getPort());
