package org.com.gate.config;

import lombok.extern.slf4j.Slf4j;
import org.com.gate.domain.route.RouteMatcher;
import org.com.gate.domain.route.RouteRepository;
...
public class GrpcClientConfig {
    ...
    @Bean
    public RouteMatcher routeMatcher(RouteRepository routeRepository) {
        return new RouteMatcher(routeRepository);
    }
