  ...
  <div class="msg-row" :class="{ other: !isSelf }">
    <template v-if="isSelf">
      ...
      <div class="content left">
        ...
        <div class="file-message">
          ...
          <div class="file-info">
            ...
            <div class="file-details">
              ...
              <span class="file-type">{{ fileInfo.fileSuffix.toUpperCase() }}</span>
            </div>
            <div class="file-actions">
              <button
                class="action-btn download-btn"
                @click="downloadFile"
                :disabled="isDownloading || downloadState.status === 'downloading'"
        ...
        <!-- 下载进度条 -->
        <div
          v-if="downloadState.status === 'downloading' && downloadState.progress"
